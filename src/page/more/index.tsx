    ...
    switch (type) {
      ...
      case "consulting":
        return (
          <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none">
            <defs>
              <linearGradient id="gradient-consulting" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style={{ stopColor: '#3182F6' }} />
                <stop offset="100%" style={{ stopColor: '#00C896' }} />
              </linearGradient>
            </defs>
            <circle cx="12" cy="12" r="10" stroke="url(#gradient-consulting)" strokeWidth="2" fill="url(#gradient-consulting)" fillOpacity="0.1" />
            <path d="M9.09 9C9.3251 8.33167 9.78915 7.76811 10.4 7.40913C11.0108 7.05016 11.7289 6.91894 12.4272 7.03871C13.1255 7.15849 13.7588 7.52152 14.2151 8.06353C14.6713 8.60553 14.9211 9.29152 14.92 10C14.92 12 11.92 13 11.92 13" stroke="url(#gradient-consulting)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            <circle cx="12" cy="17" r="1" fill="url(#gradient-consulting)" />
          </svg>
        );
      case "inquiry":
        return (
