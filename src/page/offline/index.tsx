              ...
              <div className="bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300">
                ...
                <div className={`bg-gradient-to-br ${program.bgColor} p-8 pb-16 relative`}>
                  ...
                  <div className="absolute -bottom-16 left-1/2 transform -translate-x-1/2 z-10">
                    <div className="w-32 h-32 rounded-[2.5rem] bg-white shadow-xl flex items-center justify-center text-6xl border-4 border-white group-hover:scale-110 transition-transform duration-300">
                      {program.imageUrl}
                    </div>
                  </div>
                </div>
